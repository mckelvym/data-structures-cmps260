// jmm0468
// cmps260 s3
// arrayStringListType.h

#ifndef H_arrayStringListType
#define H_arrayStringListType

#include <string>
using namespace std;

class arrayStringListType
{
public:
    bool isEmpty() const;
    ...
    bool isItemAtEqual(int location, string item) const;
    ...
    void removeAt(int location);
      ...
      //       is displayed.
    void retrieveAt(int location, string& retItem);
    ...
    int seqSearch(string item) const;
    ...
    void remove(string removeItem);
      ...
      //      decremented by one.
    arrayStringListType(int size = 100);
       //constructor
      //Creates an array of the size specified by the 
      //parameter size. The default array size is 100.
      //Postcondition: The list points to the array, length = 0,
      //               and maxSize = size
    arrayStringListType (const arrayStringListType& otherList); 
       //copy constructor
    ~arrayStringListType();
      //destructor
